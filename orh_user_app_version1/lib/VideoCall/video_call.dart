...
class MeetingController extends GetxController {
  ...
  VideoRendererAdapter? get _localVideo {
    print('VideoRendererAdapter dotor');
    print(VideoRendererAdapter);
  ...
  List<VideoRendererAdapter> get _remoteVideos {
    ...
    print('rimote videos dotor');
    print(videoRenderers.value);
    print('0');
    videoRenderers.value.forEach((element) {
      if (!element.local) {
  ...
  _turnCamera() {
    print('camera gaa asaah gej oroldoj bna hoorhiis');
    print(_localVideo.toString());
    print('and');
    print(_localVideo!.stream.getVideoTracks().length.toString());
    if (_localVideo != null &&
        _localVideo!.stream.getVideoTracks().length > 0) {
...
class MeetingView extends GetView<MeetingController> {
  ...
  Widget _buildMajorVideo() {
    return Obx(() {
      print('remote videos bgaa esehiig harii');
      print(remoteVideos.length);
