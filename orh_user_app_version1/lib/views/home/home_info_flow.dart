...
class _HomeInfoFlowState extends State<HomeInfoFlow>
  ...
  Future<bool> cloaseTheApp(BuildContext context) async {
    return await Get.defaultDialog(
        title: 'Эрүүл Gerege ийг хаах уу?',
                ...
                children: [
                  Padding(
                    ...
                    padding: EdgeInsets.fromLTRB(
                        GeneralMeasurements.deviceHeight / 100 * 2,
                        GeneralMeasurements.deviceHeight / 100 * 2,
                        0,
                        GeneralMeasurements.deviceHeight / 100 * 1),
                    child: Column(
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      // vvsgeh button uudiin row
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        InkWell(
                          //survey
                          onTap: () async {
                            var surveyCreationController =
                                Get.find<CreationCont>();
                            surveyCreationController.randomString =
                                generateRandomString(5) +
                                    DateTime.now().toString();
                            await surveyCreationController
                                .getSurveyCreationTypes(RouteUnits.home);
                          },
                          child: Container(
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    height:
                                        GeneralMeasurements.deviceWidth / 10,
                        ...
                        InkWell(
                          ...
                          child: Container(
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    height: GeneralMeasurements.deviceWidth /
                                        100 *
                                        10,
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) => InkWell(
                              ...
                              child: AnimatedContainer(
                                ...
                                width:
                                    GeneralMeasurements.deviceWidth / 100 * 30,
                                height: 50,
                                decoration: BoxDecoration(
                                  color: index == _currentIndex
                                      ? CommonColors.geregeBlue
                  ...
                  Container(
                    ...
                    child: PageView(
                      ...
                      children: const [HomePagePublic(), HomePageWorkSpace()],
                    ),
                  )
                ],
              ),
              Padding(
                // upper navigation btn
                padding: EdgeInsets.fromLTRB(
                    0,
                    GeneralMeasurements.deviceWidth / 9.5,
                    GeneralMeasurements.deviceWidth / 15,
                    0),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
        ...
        child: ListView(
          children: [
            ...
            homePageCard(
              ...
              'Эмнэлэгүүд',
              () {
                Get.toNamed(RouteUnits.hospitals,
                    arguments: RouteUnits.fromHospitals);
                GlobalHelpers.bottomnavbarSwitcher.add(true);
              },
            ),
            homePageCard(
              ...
              'Эмч нар',
              () {
                Get.toNamed(RouteUnits.doctors,
                    arguments: RouteUnits.fromDoctors);
                GlobalHelpers.bottomnavbarSwitcher.add(true);
              },
            ),
            homePageCard(
              ...
              () {
                Get.toNamed(RouteUnits.preDiagnosis,
                    arguments: RouteUnits.home);
                GlobalHelpers.bottomnavbarSwitcher.add(true);
              },
            ),
            homePageCard(
...
class _HomePagePublicState extends State<HomePagePublic> {
  ...
  @override
  Widget build(BuildContext context) {
    return Scaffold(body: GetX<SCont>(builder: (surveyControllerList) {
      return Stack(
        children: [
          SizedBox(
            child: SingleChildScrollView(
              ...
              child: ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: surveyControllerList
                          .publicSurveyList.value.result?.length ??
                      0,
                  itemBuilder: (context, index) {
                    var item = surveyControllerList
                        .publicSurveyList.value.result![index];
                    return PublicsUnit(
    ...
    return Scaffold(body: GetX<SCont>(builder: (surveyControllerList) {
      return Stack(
        children: [
          SizedBox(
            child: SingleChildScrollView(
              ...
              child: ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: surveyControllerList
                          .wrkSpaceSurveyList.value.result?.length ??
                      0,
                  itemBuilder: (context, index) {
                    var item = surveyControllerList
                        .wrkSpaceSurveyList.value.result![index];
                    return SegsUnit(
                      surveyName: item.name ?? "",
                      surveyId: item.id!,
                      itemindx: index,
          ...
          Visibility(
              visible:
                  surveyControllerList.wrkSpaceSurveyList.value.result!.isEmpty
                      ? true
                      : false,
              child: Image.asset('assets/images/empty_box.jpg'))
        ],
