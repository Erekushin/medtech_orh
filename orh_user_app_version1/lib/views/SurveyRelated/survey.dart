...
class _SurveyUnit extends State<SurveyUnit> {
  ...
  void initState() {
    super.initState();
    GlobalHelpers.queryPageCount =
        queryController.queryQuestions.result!.questions!.length ~/
...
class _PageUnitState extends State<PageUnit> {
      ...
      return DropdownMenuItem(
          onTap: () {
            Get.find<SurveyController>()
                ...
                .result!
                .aimagCode = item.aimagCode!;
            Get.find<SurveyController>()
                .researcherDefaultData
                .result!
                .aimagName = item.aimagName!;
            Get.find<SurveyController>().chosenAimag.value =
                aimagList.indexOf(item);
          },
  ...
  List<DropdownMenuItem<String>> sumItems(List<Sums> sumList) {
    return sumList.map((item) {
      return DropdownMenuItem(
          onTap: () {
            Get.find<SurveyController>().researcherDefaultData.result!.sumCode =
                item.sumCode!;
            Get.find<SurveyController>().researcherDefaultData.result!.sumName =
                item.sumName!;
          },
          value: item.sumName,
          ...
          child: Column(
            children: [
                          ...
                          Visibility(
                            ...
                            child: Column(
                              ...
                              children: [
                                    ...
                                    GetX<SurveyController>(
                                      ...
                                      return Icon(
                                        ...
                                        setState(() {
                                          ...
                                          surveyController
                                              .haveDefaultData.value = false;
                                          surveyController.researcherDefaultData
                                                  .result!.userId =
                                              Get.find<LoginController>()
                                                  ...
                                                  .id;
                                          surveyController
                                              .researcherDefaultDataUpdateAndPush();
                                        });
                                      });
                                    })
                                  ],
                                ...
                                myText(
                                    surveyControllerOut.currentDate
                                        .toString()
                                        .substring(0, 10),
                                    16,
                                    1.5),
                                Container(
                                  ...
                                  child: DropdownButton<String>(
                                      ...
                                      items: aimagItems(
                                          GlobalHelpers.aimagList.aimags!)),
                                ),
                                GetX<SurveyController>(
                                    builder: (surveyController) {
                                  return Container(
                                    ...
                                    child: DropdownButton<String>(
                                        ...
                                        isExpanded: true,
                                        borderRadius: BorderRadius.circular(5),
                                        items: sumItems(GlobalHelpers
                                            .aimagList
                                            .aimags![surveyController
                                                .chosenAimag.value]
                                            .sums!)),
                                  );
                                })
              ...
              widget.pageIndex == 0
                  ? myTextField(
                      'Регистрийн дугаар',
                      surveyControllerOut.rdTxtController,
                      0,
                      0,
                      20,
                      20,
                  ...
                  : const SizedBox(),
              widget.pageIndex == 0
                  ? GetX<SettingController>(builder: (settingsController) {
                      return SizedBox(
                        child: settingsController.xyrServiceSwitcher.value
                            ? const SizedBox()
                            : Column(
                                children: [
                                  Container(
                                  ...
                                  Container(
                                      ...
                                      child: TextField(
                                        decoration: const InputDecoration(
                                            hintText: 'Нэр', labelText: 'Нэр'),
                                        controller:
                                            surveyControllerOut.firstName,
                                      )),
                                  Container(
                                      margin: const EdgeInsets.only(
                                          left: 20,
              ...
              widget.pageIndex == 0
                  ? GetX<SurveyController>(builder: (surveyController) {
                      return myText(surveyControllerOut.xyrName.value, 15, 1,
                          FontWeight.bold);
                    })
                  : const SizedBox(),
              SizedBox(
                height: widget.pageIndex == 0
                    ? GeneralMeasurements.deviceHeight * .7
                ...
                child: ListView.builder(
                    ...
                    itemCount:
                        widget.pageIndex == GlobalHelpers.queryPageCount - 1
                            ? surveyControllerOut.queryQuestions.result!
                                            .questions!.length %
                                        AllSizes.pageQuestionCount !=
                                    0
                                ? surveyControllerOut.queryQuestions.result!
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      final int queryUnitIndex =
                          widget.pageIndex * AllSizes.pageQuestionCount + index;
                      final item = surveyControllerOut
                          .queryQuestions.result!.questions![queryUnitIndex];
                      surveyControllerOut.textEditingControllers
                        ...
                        Container(
                          ...
                          child: myBtn(
                            ...
                            if (surveyControllerOut.haveDefaultData.value) {
                              if (GlobalHelpers.isXyrNull ||
                                ...
                                try {
                                  surveyControllerOut.queryAnswer.regNo =
                                      surveyControllerOut.rdTxtController.text;
                                  if (settingsControllerOut
                                      .xyrServiceSwitcher.value) {
                                    surveyControllerOut.queryAnswer.gender =
                                        surveyControllerOut
                                            .xyrInfo.result!.gender
                                            .toString();
                                    surveyControllerOut.queryAnswer.age =
                                        surveyControllerOut.xyrInfo.result!.age;
                                    surveyControllerOut.queryAnswer.fistName =
                                        surveyControllerOut
                                            .xyrInfo.result!.firstName;
                                    surveyControllerOut.queryAnswer.lastName =
                                        surveyControllerOut
                                            .xyrInfo.result!.lastName;
                                  } else {
                                    surveyControllerOut.queryAnswer.gender =
                                        surveyControllerOut.gender.text;
                                    surveyControllerOut.queryAnswer.age =
                                        surveyControllerOut.age.text;
                                    surveyControllerOut.queryAnswer.fistName =
                                        surveyControllerOut.firstName.text;
                                    surveyControllerOut.queryAnswer.lastName =
                                        surveyControllerOut.lastName.text;
                                  }

                                  surveyControllerOut
                                          .queryAnswer.researcherGeregeID =
                                      Get.find<LoginController>()
                                          .geregeUser
                                          .result!
                                          .id;
                                  surveyControllerOut.queryAnswer.aimagCode =
                                      surveyControllerOut.researcherDefaultData
                                          .result!.aimagCode;
                                  ...
                                  surveyControllerOut.queryAnswer.sumName =
                                      surveyControllerOut.researcherDefaultData
                                          .result!.sumName;
                                  surveyControllerOut.queryAnswer.surveyId =
                                      '4'; // saijruulna
                              ...
                              Get.snackbar('Талбарын мэдээлэл дутуу байна',
                                  'Судалгааг авч буй байршилын мэдээллийг оруулна уу!',
                                  snackPosition: SnackPosition.BOTTOM,
                                  colorText: Colors.white,
                                  backgroundColor: Colors.grey[900],
                                  margin: const EdgeInsets.all(5));
        ...
        Align(
          ...
          child: Container(
              ...
              child: Text((widget.pageIndex + 1).toString() +
                  '/' +
                  GlobalHelpers.queryPageCount.toString())),
        )
      ],
    );
  }
...
class _RecieverUnit extends State<RecieverUnit> {
  ...
  Widget categorization(int type) {
    switch (type) {
      case 0:
        return myTextField(
            widget.questionText,
            queryController.textEditingControllers[widget.questionIndex],
            5,
            5,
            20,
            20,
      ...
      default:
        return MyDropdown(
          dropDownHint: widget.questionText,
          listitems: widget.options,
          currentValue: 0,
          mark: 'mark',
          givenModelType: Options,
          margint: 5,
          marginb: 5,
          marginr: 20,
          marginl: 20,
  ...
  @override
  Widget build(BuildContext context) {
    return Container(child: categorization(widget.type));
  }
}
