    ...
    for (int w = 0; w < sCCont.surveys.length; w++) {
      for (int q = w + 1; q < sCCont.surveys.length; q++) {
        if (sCCont.surveys[w].connectedid == sCCont.surveys[q].preconnected) {
          Node node1 = nodes.firstWhere((element) =>
              element.key!.value == sCCont.surveys[w].connectedid!);
          Node node2 = nodes.firstWhere((element) =>
              element.key!.value == sCCont.surveys[q].connectedid!);
              ...
              Row(
                children: [
                  ...
                  SizedBox(
                      width: 150,
                      child: myText(
                          sCCont.torolStr ?? 'төрлийг сонгоогүй байна.', 15, 1))
                ],
              ),
              const SizedBox(
                height: 20,
              ...
              Row(
                children: [
                  ...
                  SizedBox(
                      ...
                      child: myText(
                          sCCont.levelStr ??
                              'Нууцлалын түвшинг сонгоогүй байна',
                          15,
                          1))
                ],
              ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: Color(int.parse(
                            sCCont.surveyCreationbody.surveyClr ??
                                '0xFFFFFFFF')),
                                  ...
                                  builder: (contextt, setState) => AlertDialog(
                                      ...
                                      content: Container(
                                        ...
                                        width: GeneralMeasurements.deviceWidth *
                                            .8,
                                        height:
                                            GeneralMeasurements.deviceHeight *
                                                .6,
                                        child: InteractiveViewer(
                                          ...
                                          child: GraphView(
                                            ...
                                            builder: (node) {
                                              ...
                                              final connectedId =
                                                  node.key!.value as int;
                                              return Chip(
                                                label: InkWell(
                                                    onTap: () {
                                                      print('dfdffd');
                                                      int idx = sCCont.surveys
                                                          .indexOf(sCCont
                                                              .surveys
                                                              .firstWhere((element) =>
                                                                  element
          ...
          Column(
            children: [
              ...
              InkWell(
                ...
                child: myBtn(CommonColors.yellow, 200, 50, CommonColors.yellow,
                    Colors.white, 'Судалгааг хадаглах'),
              ),
              const SizedBox(
                height: 20,
              )
