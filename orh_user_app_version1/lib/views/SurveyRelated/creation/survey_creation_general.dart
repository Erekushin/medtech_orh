...
class _SurveyCreationGeneralState extends State<SurveyCreationGeneral> {
  ...
  List<DropdownMenuItem<String>> dropitems(
      List<TypeInfo> itemlist, String key) {
                ...
                Column(
                  ...
                  children: [
                    ...
                    DropdownButton<String>(
                          ...
                          setState(() {
                            ...
                            switch (newValue) {
                              case 'public':
                                ...
                                break;
                              case 'segmented':
                                sCCont.researchetTextController
                        ...
                        borderRadius: BorderRadius.circular(5),
                        items: dropitems(
                            sCCont.surveyCreationTypes.result!.privacyLevel ??
                                [],
                            'surveyLevel')),
                    Container(
                      //option container
                        ...
                        child:
                          ...
                          return ListView.builder(
                              ...
                              itemCount: surveyControllermini
                                  .researchetTextController.length,
                                      ...
                                      child: TextField(
                                        onChanged: (string) {
                                          surveyControllermini
                                              .researcherPhoneList[index]
                                              .researcherPhone = string;
                                        },
                                        controller: sCCont
                                            .researchetTextController[index],
                                        decoration: const InputDecoration(
                        ...
                        InkWell(
                          ...
                          child: Container(
                              ...
                              child: Visibility(
                                ...
                                child: Icon(
                                  Icons.check,
                                  size: GeneralMeasurements.deviceHeight /
                                      100 *
                                      4,
                                  color: Colors.green,
                                ),
