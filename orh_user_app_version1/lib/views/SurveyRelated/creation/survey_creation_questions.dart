...
class _SurveyCreationQuestionState extends State<SurveyCreationQuestion> {
  ...
  void initState() {
    ...
    if (sCreCont.newQuestionList.isEmpty) {
      sCreCont.surveyCreationbody.questions = List<Questions>.generate(
          1, ((index) => Questions(questionText: 'fdfdfd', options: []))).obs;
      sCreCont.qTxts.add(TextEditingController());
      sCreCont.qTypes.add(DropSelectVal());
      sCreCont.staTypes.add(DropSelectVal());
      sCreCont.newQuestionList.add(Questions(
          options: [], statistics: statistics, questionType: questionType));
    }
  }
      ...
      children: [
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    switch (controller.newQuestionList[index].type) {
                      case 10:
                        return toolUI(index);
                      default:
                        return SurveyInputCreation(
                            surveyQuestionIndex: index,
                            textController: sCreCont.qTxts[index]);
                    }
                  },
                );
              },
        ...
        Align(
          ...
          child: Row(
            ...
            children: [
              GetX<CreationCont>(builder: (surveyCreationCont) {
                return Container(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          myText(
                              surveyCreationCont.newQuestionList.length
                                  .toString(),
                              12,
                              1,
                              (FontWeight.bold)),
                      ...
                      Row(
                        children: [
                          ...
                          myText(
                              surveyCreationCont.toolQuestionCount.toString(),
                              12,
                              1,
                              (FontWeight.bold)),
                        ],
              ...
              Container(
                ...
                child: InkWell(
                    ...
                    Get.defaultDialog(
                        ...
                        content: SizedBox(
                          child: Column(
                            children: [
                              myText(
                                  'Доорх хэрэглэгдэхүүнүүдээс сонгон өөрийн судалгааны асуултанд нэмэх боломжтой',
                                  15,
                                  1),
                              InkWell(
                                onTap: () {
                                  ...
                                  sCreCont.qTxts
                                      .insert(i, TextEditingController());
                                  sCreCont.newQuestionList.insert(
                                      i,
                                      Questions(
                                          type: 10,
                                          questionText: 'Регистрээ оруулах',
                                          options: []));
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    children: [
                                      myText('РД аар иргэний мэдээлэл авах', 15,
                                          1, (FontWeight.bold)),
                                      myText(
                                          'судлуулагчийн овог, нэр, утас, гэрийн хаягыг улсын бүргэлийн сангаас авах боломжтой',
                                          15,
                                          1)
                                    ],
                                  ),
                  ...
                  child: myBtn(CommonColors.yellow, 80, 50, CommonColors.yellow,
                      CommonColors.geregeBlue, 'tools'),
                ),
              )
            ],
          ),
...
class SurveyInputCreation extends StatefulWidget {
  const SurveyInputCreation(
      {Key? key,
      required this.surveyQuestionIndex,
...
class _SurveyInputCreationState extends State<SurveyInputCreation> {
  ...
  callBackFunc(int chosenVal, int index) {
    //drop down nii value nuudaas ali ni songogdson iig yalgah
    ...
    switch (chosenVal) {
      case 8:
        setState(() {
          ...
          sCCont
              .newQuestionList[widget.surveyQuestionIndex].optionTextController
              .clear();
          sCCont.newQuestionList[widget.surveyQuestionIndex].containerHeight =
              210;
      ...
      case 7:
        if (sCCont
            .newQuestionList[widget.surveyQuestionIndex].options.isEmpty) {
          if (sCCont.newQuestionList[widget.surveyQuestionIndex]
                  .containerHeight ==
              210) {
            setState(() {
              sCCont.newQuestionList[widget.surveyQuestionIndex]
                  .containerHeight = sCCont
                      .newQuestionList[widget.surveyQuestionIndex]
                      .containerHeight! +
                  50;
              sCCont.newQuestionList[widget.surveyQuestionIndex].options
                  .add(Options());
              sCCont.newQuestionList[widget.surveyQuestionIndex]
  ...
  void initState() {
    super.initState();
    if (sCCont.newQuestionList[widget.surveyQuestionIndex].containerHeight ==
        null) {
      ...
      child: Row(
        ...
        children: [
          Container(
              ...
              height: sCCont
                  .newQuestionList[widget.surveyQuestionIndex].containerHeight,
              ...
              child: Column(
                ...
                children: [
                  ...
                  QStaDrop(
                    dropDownHint: 'Статистик үзүүлэлт нэмэх',
                    listitems: sCCont
                        .newQuestionList[widget.surveyQuestionIndex]
                        .statistics!,
                    answerIndex: widget.surveyQuestionIndex,
                    callBackFunction: () {},
                  ),
                  QTypeDrop(
                    dropDownHint: 'Асуултын төрлийг сонгох',
                    listitems: sCCont
                        .newQuestionList[widget.surveyQuestionIndex]
                        .questionType!,
                    answerIndex: widget.surveyQuestionIndex,
                  ...
                  Container(
                    ...
                    child: Expanded(
                      child:
                          GetX<CreationCont>(builder: (surveyControllermini) {
                        return ListView.builder(
                            scrollDirection: Axis.vertical,
                            shrinkWrap: true,
                            itemCount: surveyControllermini
                                .newQuestionList[widget.surveyQuestionIndex]
                                .options
                                .length,
                                ...
                                children: [
                                  Expanded(
                                    child: TextField(
                                      controller: sCCont
                                          .newQuestionList[
                                              widget.surveyQuestionIndex]
                                          .optionTextController[index],
                                      onChanged: (string) {
                                        sCCont
                                            .newQuestionList[
                                                widget.surveyQuestionIndex]
          ...
          if (sCreCont.newQuestionList[index].type != null) {
            ...
            sCreCont.newQuestionList.insert(
                ...
                Questions(
                    ...
                    questionType:
                        sCreCont.surveyCreationTypes.result!.questionType!));
          } else {
            Get.snackbar(
                'Талбаруудын утга хоосон байна', "Асуултын төрлийг сонгоно уу",
                snackPosition: SnackPosition.BOTTOM,
                colorText: Colors.white,
                backgroundColor: Colors.grey[900],
                margin: const EdgeInsets.only(left: 5, right: 5, bottom: 80));
          }
        },
        child: myBtn(CommonColors.yellow, 30, 30, CommonColors.yellow,
            Colors.grey, '\u{02C4}', 10, 25),
      ),
      InkWell(
        onTap: () {
        ...
        child: myBtn(CommonColors.yellow, 30, 30, CommonColors.yellow,
            Colors.grey, 'DEL', 10, 12),
      ),
      InkWell(
        // dooshoo nemeh
        onTap: () {
          if (sCreCont.newQuestionList[index].type != null) {
            if (sCreCont.torolStr == "Auto" &&
                sCreCont.newQuestionList[index].type != 7) {
              Get.snackbar('', "асуултыг сонголт хэлбэрээр үүсгэнэ үү",
                  snackPosition: SnackPosition.BOTTOM,
                  colorText: Colors.white,
                  backgroundColor: Colors.grey[900],
                  margin: const EdgeInsets.only(left: 5, right: 5, bottom: 80));
              ...
              sCreCont.newQuestionList.insert(
                  ...
                  Questions(
                      options: [],
                      statistics:
                          sCreCont.surveyCreationTypes.result!.statistic!,
                      questionType:
                          sCreCont.surveyCreationTypes.result!.questionType!));
            }
          } else {
