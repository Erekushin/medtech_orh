...
class _MyDropDownState extends State<MyDropdown> {
  final queryController = Get.find<CreationCont>();
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Column(
          ...
          value: queryController.qTypes[widget.answerIndex].value,
          onChanged: (String? newValue) {
            setState(() {
              print(newValue);
              queryController.qTypes[widget.answerIndex].value = newValue.toString();
            });
