...
class _OptionDropState extends State<OptionDrop> {
  ...
  @override
  void initState() {
    sCont.surveyAnswer.answers![widget.answerIndex].questionId =
      ...
      return optionList.map((item) {
        return DropdownMenuItem(
          ...
          onTap: () {
            sCont.surveyAnswer.answers![widget.answerIndex].questionId =
                int.parse(widget.questionID!);
            sCont.surveyAnswer.answers![widget.answerIndex].optionId =
                item.optionId;

            sCont.dropvalueList[widget.answerIndex].numVal =
                item.num.toString();
          },
        );
      }).toList();
        ...
        children: [
          ...
          DropdownButton<String>(
              ...
              onChanged: (String? newValue) {
                setState(() {
                  sCont.dropvalueList[widget.answerIndex].value =
                      newValue.toString();
                });
              },
