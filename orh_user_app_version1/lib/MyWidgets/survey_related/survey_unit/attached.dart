      ...
      return GestureDetector(
          onTap: () {
            try {
              ...
              sCont.attachedList.value.result![widget.itemindx].loading.value =
                  true;
          ...
          child: Container(
              ...
              decoration: BoxDecoration(
                border: Border.all(
                    color: sCont.attachedList.value.result![widget.itemindx]
                        .borderColor.value),
                color: Colors.white,
                boxShadow: [
                  BoxShadow(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      sCont.attachedList.value.result![widget.itemindx].loading
                              .value
                          ? const SizedBox(
                              width: 20,
                              height: 20,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            sCont.attachedList.value.result![widget.itemindx]
                                .creatorName!,
