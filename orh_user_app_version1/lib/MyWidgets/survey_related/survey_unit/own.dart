    ...
    return GetX<SCont>(builder: (sCont) {
      return GestureDetector(
          onLongPress: () {
            ...
            sCont.ownSurveyListbody.value.result![widget.itemindx].borderColor
                .value = Colors.red;
          ...
          child: Container(
              ...
              decoration: BoxDecoration(
                border: Border.all(
                    color: sCont.ownSurveyListbody.value
                        .result![widget.itemindx].borderColor.value),
                color: Colors.white,
                boxShadow: [
                  BoxShadow(
                  ...
                  Row(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child:
                            myText(widget.surveyName, 17, 1, FontWeight.w700),
                      ),
                      sCont.ownSurveyListbody.value.result![widget.itemindx]
                              .loading.value
                          ? const SizedBox(
                              width: 20,
                              height: 20,
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text(
                            sCont.ownSurveyListbody.value
                                .result![widget.itemindx].creatorName!,
